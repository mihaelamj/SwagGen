 ...
 */
                ...
                public init(ids: [String], pageSize: Int? = nil, maxRating: String? = nil, order: EvenListOrder? = nil, orderBy: EvenListOrderBy? = nil, itemType: EvenItemType? = nil, device: String? = nil, sub: String? = nil, segments: [String]? = nil, ff: [EvenFeatureFlags]? = nil) {
                    self.ids = ids
            ...
            public convenience init(ids: [String], pageSize: Int? = nil, maxRating: String? = nil, order: EvenListOrder? = nil, orderBy: EvenListOrderBy? = nil, itemType: EvenItemType? = nil, device: String? = nil, sub: String? = nil, segments: [String]? = nil, ff: [EvenFeatureFlags]? = nil) {
