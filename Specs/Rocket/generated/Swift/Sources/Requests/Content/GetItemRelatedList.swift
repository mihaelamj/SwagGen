 ...
 */
                ...
                public init(id: String, page: Int? = nil, pageSize: Int? = nil, maxRating: String? = nil, device: String? = nil, sub: String? = nil, segments: [String]? = nil, ff: [EvenFeatureFlags]? = nil) {
                    self.id = id
                    self.page = page
            ...
            public convenience init(id: String, page: Int? = nil, pageSize: Int? = nil, maxRating: String? = nil, device: String? = nil, sub: String? = nil, segments: [String]? = nil, ff: [EvenFeatureFlags]? = nil) {
