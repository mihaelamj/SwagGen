...
extension Rocket.Account {
    ...
    public enum GetProfileWithId {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = EvenProfileSummary

            /** OK */
            case status200(EvenProfileSummary)
            ...
            public var success: EvenProfileSummary? {
                switch self {
            ...
            public var responseResult: APIResponseResult<EvenProfileSummary, EvenServiceError> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(EvenProfileSummary.self, from: data))
