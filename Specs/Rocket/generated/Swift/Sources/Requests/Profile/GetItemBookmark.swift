...
extension Rocket.Profile {
    ...
    public enum GetItemBookmark {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = EvenBookmark

            /** OK */
            case status200(EvenBookmark)
            ...
            public var success: EvenBookmark? {
                switch self {
            ...
            public var responseResult: APIResponseResult<EvenBookmark, EvenServiceError> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(EvenBookmark.self, from: data))
