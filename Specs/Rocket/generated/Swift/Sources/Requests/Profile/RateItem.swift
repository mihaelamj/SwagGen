 ...
 */
    public enum RateItem {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = EvenUserRating

            /** OK. */
            case status200(EvenUserRating)
            ...
            public var success: EvenUserRating? {
                switch self {
            ...
            public var responseResult: APIResponseResult<EvenUserRating, EvenServiceError> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(EvenUserRating.self, from: data))
