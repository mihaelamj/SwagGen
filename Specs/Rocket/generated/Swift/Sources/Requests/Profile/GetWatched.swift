...
extension Rocket.Profile {
    ...
    public enum GetWatched {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = [String: EvenWatched]

            /** OK */
            case status200([String: EvenWatched])
            ...
            public var success: [String: EvenWatched]? {
                switch self {
            ...
            public var responseResult: APIResponseResult<[String: EvenWatched], EvenServiceError> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode([String: EvenWatched].self, from: data))
