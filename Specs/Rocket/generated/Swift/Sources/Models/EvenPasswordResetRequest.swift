...
public class EvenPasswordResetRequest: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenPasswordResetRequest else { return false }
      guard self.email == object.email else { return false }
      guard self.password == object.password else { return false }
      return true
    }

    public static func == (lhs: EvenPasswordResetRequest, rhs: EvenPasswordResetRequest) -> Bool {
