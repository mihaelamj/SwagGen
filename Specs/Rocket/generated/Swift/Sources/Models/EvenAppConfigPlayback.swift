...
public class EvenAppConfigPlayback: APIModel {
 ...
 */
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenAppConfigPlayback else { return false }
    ...
    public static func == (lhs: EvenAppConfigPlayback, rhs: EvenAppConfigPlayback) -> Bool {
