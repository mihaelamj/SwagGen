...
public class EvenPlan: APIModel {
    ...
    public enum EvenRevenueType: String, Codable, Equatable, CaseIterable {
        case tvod = "TVOD"
        case svod = "SVOD"
        case undecodable
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.singleValueContainer()
            let rawValue = try container.decode(String.self)
            self = EvenRevenueType(rawValue: rawValue) ?? .undecodable
        }
    }

    /** The type of billing period used. */
    public enum EvenBillingPeriodType: String, Codable, Equatable, CaseIterable {
        case week = "week"
        case month = "month"
        case year = "year"
        case none = "none"
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.singleValueContainer()
            let rawValue = try container.decode(String.self)
            self = EvenBillingPeriodType(rawValue: rawValue) ?? .undecodable
        }
    }
    ...
    /** The revenue type a plan targets. */
    public var revenueType: EvenRevenueType
    ...
    /** The type of billing period used. */
    public var billingPeriodType: EvenBillingPeriodType
    ...
    public init(id: String, title: String, tagline: String, type: EvenType, isFeatured: Bool, isActive: Bool, isPrivate: Bool, revenueType: EvenRevenueType, subscriptionCode: String, alias: String, benefits: [String], billingPeriodType: EvenBillingPeriodType, billingPeriodFrequency: Int, hasTrialPeriod: Bool, trialPeriodDays: Int, termsAndConditions: String, currency: String, customFields: [String: Any]? = nil, price: Float? = nil) {
        self.id = id
        self.title = title
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenPlan else { return false }
    ...
    public static func == (lhs: EvenPlan, rhs: EvenPlan) -> Bool {
