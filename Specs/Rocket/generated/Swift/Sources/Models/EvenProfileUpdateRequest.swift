...
public class EvenProfileUpdateRequest: APIModel {
 ...
 */
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenProfileUpdateRequest else { return false }
    ...
    public static func == (lhs: EvenProfileUpdateRequest, rhs: EvenProfileUpdateRequest) -> Bool {
