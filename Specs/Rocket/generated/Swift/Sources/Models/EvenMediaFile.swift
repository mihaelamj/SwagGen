...
public class EvenMediaFile: APIModel {
    ...
    public init(name: String, deliveryType: EvenDeliveryType, url: URL, drm: String, format: String, resolution: EvenResolution, width: Int, height: Int, language: String, channels: Int? = nil) {
        self.name = name
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenMediaFile else { return false }
    ...
    public static func == (lhs: EvenMediaFile, rhs: EvenMediaFile) -> Bool {
