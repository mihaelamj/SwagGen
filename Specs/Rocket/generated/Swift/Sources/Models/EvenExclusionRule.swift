...
public class EvenExclusionRule: APIModel {

    /** Defines playback exclusion rules for an Offer or Entitlement. */
    public enum EvenExcludeDelivery: String, Codable, Equatable, CaseIterable {
        case stream = "Stream"
        ...
        public init(from decoder: Decoder) throws {
            ...
            self = EvenExcludeDelivery(rawValue: rawValue) ?? .undecodable
        }
    }

    /** Defines playback exclusion rules for an Offer or Entitlement. */
    public enum EvenExcludeMinResolution: String, Codable, Equatable, CaseIterable {
        case sd = "SD"
        case hd720 = "HD-720"
        case hd1080 = "HD-1080"
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.singleValueContainer()
            let rawValue = try container.decode(String.self)
            self = EvenExcludeMinResolution(rawValue: rawValue) ?? .undecodable
        }
    }
    ...
    public var excludeDelivery: EvenExcludeDelivery?

    public var excludeMinResolution: EvenExcludeMinResolution?

    public init(description: String? = nil, device: String? = nil, excludeAirplay: Bool? = nil, excludeChromecast: Bool? = nil, excludeDelivery: EvenExcludeDelivery? = nil, excludeMinResolution: EvenExcludeMinResolution? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenExclusionRule else { return false }
    ...
    public static func == (lhs: EvenExclusionRule, rhs: EvenExclusionRule) -> Bool {
