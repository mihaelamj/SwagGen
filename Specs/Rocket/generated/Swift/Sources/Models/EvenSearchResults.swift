...
public class EvenSearchResults: APIModel {
    ...
    public var items: EvenItemList?

    public var movies: EvenItemList?

    /** The list of people relevant to the search term. */
    public var people: [EvenPerson]?

    public var tv: EvenItemList?

    public init(term: String, total: Int, items: EvenItemList? = nil, movies: EvenItemList? = nil, people: [EvenPerson]? = nil, tv: EvenItemList? = nil) {
        self.term = term
        self.total = total
        self.items = items
        self.movies = movies
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenSearchResults else { return false }
    ...
    public static func == (lhs: EvenSearchResults, rhs: EvenSearchResults) -> Bool {
