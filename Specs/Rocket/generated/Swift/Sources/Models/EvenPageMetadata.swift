...
public class EvenPageMetadata: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenPageMetadata else { return false }
      guard self.description == object.description else { return false }
      guard self.keywords == object.keywords else { return false }
      return true
    }

    public static func == (lhs: EvenPageMetadata, rhs: EvenPageMetadata) -> Bool {
