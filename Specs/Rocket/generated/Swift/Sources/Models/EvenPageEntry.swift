 ...
 */
public class EvenPageEntry: APIModel {
 ...
 */
    ...
    public init(id: String, type: EvenType, title: String, template: String, customFields: [String: Any]? = nil, images: [String: URL]? = nil, item: EvenItemSummary? = nil, list: EvenItemList? = nil, people: [EvenPerson]? = nil, text: String? = nil) {
        self.id = id
        self.type = type
        self.title = title
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenPageEntry else { return false }
    ...
    public static func == (lhs: EvenPageEntry, rhs: EvenPageEntry) -> Bool {
