...
public class EvenAccountTokenRequest: APIModel {
    ...
    public enum EvenScopes: String, Codable, Equatable, CaseIterable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self = EvenScopes(rawValue: rawValue) ?? .undecodable
        }
    }
 ...
 */
    ...
    public init(email: String, scopes: [EvenScopes], cookieType: EvenCookieType? = nil, password: String? = nil, pin: String? = nil) {
        self.email = email
        self.scopes = scopes
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenAccountTokenRequest else { return false }
    ...
    public static func == (lhs: EvenAccountTokenRequest, rhs: EvenAccountTokenRequest) -> Bool {
