...
public class EvenProfileCreationRequest: APIModel {
 ...
 */
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenProfileCreationRequest else { return false }
    ...
    public static func == (lhs: EvenProfileCreationRequest, rhs: EvenProfileCreationRequest) -> Bool {
