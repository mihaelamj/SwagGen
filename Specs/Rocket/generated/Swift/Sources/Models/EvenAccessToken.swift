...
public class EvenAccessToken: APIModel {
    ...
    public init(value: String, refreshable: Bool, expirationDate: DateTime, type: EvenType) {
        self.value = value
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenAccessToken else { return false }
    ...
    public static func == (lhs: EvenAccessToken, rhs: EvenAccessToken) -> Bool {
