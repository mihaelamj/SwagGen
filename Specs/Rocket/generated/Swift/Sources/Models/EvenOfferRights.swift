...
public class EvenOfferRights: APIModel {

    /** The base type for both Offer and Entitlement. */
    public enum EvenDeliveryType: String, Codable, Equatable, CaseIterable {
        case stream = "Stream"
        ...
        public init(from decoder: Decoder) throws {
            ...
            self = EvenDeliveryType(rawValue: rawValue) ?? .undecodable
        }
    }

    /** The base type for both Offer and Entitlement. */
    public enum EvenResolution: String, Codable, Equatable, CaseIterable {
        case sd = "SD"
        case hd720 = "HD-720"
        case hd1080 = "HD-1080"
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.singleValueContainer()
            let rawValue = try container.decode(String.self)
            self = EvenResolution(rawValue: rawValue) ?? .undecodable
        }
    }

    /** The base type for both Offer and Entitlement. */
    public enum EvenOwnership: String, Codable, Equatable, CaseIterable {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.singleValueContainer()
            let rawValue = try container.decode(String.self)
            self = EvenOwnership(rawValue: rawValue) ?? .undecodable
        }
    }

    public var deliveryType: EvenDeliveryType

    public var scopes: [String]

    public var resolution: EvenResolution

    public var ownership: EvenOwnership

    /** Any specific playback exclusion rules. */
    public var exclusionRules: [EvenExclusionRule]?
    ...
    public init(deliveryType: EvenDeliveryType, scopes: [String], resolution: EvenResolution, ownership: EvenOwnership, exclusionRules: [EvenExclusionRule]? = nil, maxDownloads: Int? = nil, maxPlays: Int? = nil, playPeriod: Int? = nil, rentalPeriod: Int? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenOfferRights else { return false }
    ...
    public static func == (lhs: EvenOfferRights, rhs: EvenOfferRights) -> Bool {
