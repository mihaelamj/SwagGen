...
public class EvenInstructionStep: APIModel {

    public enum EvenSkyDirectionDescription: String, Codable, Equatable, CaseIterable {
        case north = "North"
        ...
        public init(from decoder: Decoder) throws {
            ...
            self = EvenSkyDirectionDescription(rawValue: rawValue) ?? .undecodable
        }
    }

    public enum EvenTrackType: String, Codable, Equatable, CaseIterable {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.singleValueContainer()
            let rawValue = try container.decode(String.self)
            self = EvenTrackType(rawValue: rawValue) ?? .undecodable
        }
    }
    ...
    public var pathAttribute: EvenPathAttribute?

    public var skyDirection: Int?

    public var skyDirectionDescription: EvenSkyDirectionDescription?

    public var streetName: String?

    public var trackType: EvenTrackType?

    public var turnDirection: String?

    public init(cumulativeDistance: Int? = nil, cumulativeTravelTime: Int? = nil, description: String? = nil, descriptionHeading: String? = nil, distance: Int? = nil, latitude: Double? = nil, longitude: Double? = nil, pathAttribute: EvenPathAttribute? = nil, skyDirection: Int? = nil, skyDirectionDescription: EvenSkyDirectionDescription? = nil, streetName: String? = nil, trackType: EvenTrackType? = nil, turnDirection: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenInstructionStep else { return false }
    ...
    public static func == (lhs: EvenInstructionStep, rhs: EvenInstructionStep) -> Bool {
