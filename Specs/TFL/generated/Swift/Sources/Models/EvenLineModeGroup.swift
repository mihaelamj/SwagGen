...
public class EvenLineModeGroup: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenLineModeGroup else { return false }
      guard self.lineIdentifier == object.lineIdentifier else { return false }
      guard self.modeName == object.modeName else { return false }
      return true
    }

    public static func == (lhs: EvenLineModeGroup, rhs: EvenLineModeGroup) -> Bool {
