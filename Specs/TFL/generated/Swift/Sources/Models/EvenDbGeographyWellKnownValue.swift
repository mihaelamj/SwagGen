...
public class EvenDbGeographyWellKnownValue: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenDbGeographyWellKnownValue else { return false }
    ...
    public static func == (lhs: EvenDbGeographyWellKnownValue, rhs: EvenDbGeographyWellKnownValue) -> Bool {
