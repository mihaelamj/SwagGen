...
public class EvenAccidentStatsOrderedSummary: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenAccidentStatsOrderedSummary else { return false }
    ...
    public static func == (lhs: EvenAccidentStatsOrderedSummary, rhs: EvenAccidentStatsOrderedSummary) -> Bool {
