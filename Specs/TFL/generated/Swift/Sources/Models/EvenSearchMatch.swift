...
public class EvenSearchMatch: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenSearchMatch else { return false }
    ...
    public static func == (lhs: EvenSearchMatch, rhs: EvenSearchMatch) -> Bool {
