...
public class EvenCoordinate: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenCoordinate else { return false }
    ...
    public static func == (lhs: EvenCoordinate, rhs: EvenCoordinate) -> Bool {
