...
public class EvenPlaceCategory: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenPlaceCategory else { return false }
      guard self.availableKeys == object.availableKeys else { return false }
      guard self.category == object.category else { return false }
      return true
    }

    public static func == (lhs: EvenPlaceCategory, rhs: EvenPlaceCategory) -> Bool {
