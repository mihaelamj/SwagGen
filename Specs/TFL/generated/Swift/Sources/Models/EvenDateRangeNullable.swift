...
public class EvenDateRangeNullable: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenDateRangeNullable else { return false }
      guard self.endDate == object.endDate else { return false }
      guard self.startDate == object.startDate else { return false }
      return true
    }

    public static func == (lhs: EvenDateRangeNullable, rhs: EvenDateRangeNullable) -> Bool {
