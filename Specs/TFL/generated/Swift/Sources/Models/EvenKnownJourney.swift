...
public class EvenKnownJourney: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenKnownJourney else { return false }
    ...
    public static func == (lhs: EvenKnownJourney, rhs: EvenKnownJourney) -> Bool {
