...
public class EvenOrderedRoute: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenOrderedRoute else { return false }
    ...
    public static func == (lhs: EvenOrderedRoute, rhs: EvenOrderedRoute) -> Bool {
