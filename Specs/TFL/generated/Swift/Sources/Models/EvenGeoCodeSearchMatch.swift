...
public class EvenGeoCodeSearchMatch: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenGeoCodeSearchMatch else { return false }
    ...
    public static func == (lhs: EvenGeoCodeSearchMatch, rhs: EvenGeoCodeSearchMatch) -> Bool {
