...
public class EvenRouteOption: APIModel {
    ...
    public var lineIdentifier: EvenIdentifier?

    /** Name such as "72" */
    public var name: String?

    public init(directions: [String]? = nil, id: String? = nil, lineIdentifier: EvenIdentifier? = nil, name: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenRouteOption else { return false }
    ...
    public static func == (lhs: EvenRouteOption, rhs: EvenRouteOption) -> Bool {
