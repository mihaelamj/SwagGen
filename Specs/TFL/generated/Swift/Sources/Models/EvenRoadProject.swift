...
public class EvenRoadProject: APIModel {

    public enum EvenPhase: String, Codable, Equatable, CaseIterable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self = EvenPhase(rawValue: rawValue) ?? .undecodable
        }
    }
    ...
    public init(boroughsBenefited: [String]? = nil, constructionEndDate: DateTime? = nil, constructionStartDate: DateTime? = nil, consultationEndDate: DateTime? = nil, consultationPageUrl: String? = nil, consultationStartDate: DateTime? = nil, contactEmail: String? = nil, contactName: String? = nil, cycleSuperhighwayId: String? = nil, externalPageUrl: String? = nil, phase: EvenPhase? = nil, projectDescription: String? = nil, projectId: String? = nil, projectName: String? = nil, projectPageUrl: String? = nil, projectSummaryPageUrl: String? = nil, schemeName: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenRoadProject else { return false }
    ...
    public static func == (lhs: EvenRoadProject, rhs: EvenRoadProject) -> Bool {
