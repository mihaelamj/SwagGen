...
public class EvenRoadDisruptionSchedule: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenRoadDisruptionSchedule else { return false }
      guard self.endTime == object.endTime else { return false }
      guard self.startTime == object.startTime else { return false }
      return true
    }

    public static func == (lhs: EvenRoadDisruptionSchedule, rhs: EvenRoadDisruptionSchedule) -> Bool {
