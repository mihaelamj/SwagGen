...
public class EvenStopPointCategory: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenStopPointCategory else { return false }
      guard self.availableKeys == object.availableKeys else { return false }
      guard self.category == object.category else { return false }
      return true
    }

    public static func == (lhs: EvenStopPointCategory, rhs: EvenStopPointCategory) -> Bool {
