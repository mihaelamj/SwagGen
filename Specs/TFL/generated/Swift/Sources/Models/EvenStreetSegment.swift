...
public class EvenStreetSegment: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenStreetSegment else { return false }
    ...
    public static func == (lhs: EvenStreetSegment, rhs: EvenStreetSegment) -> Bool {
