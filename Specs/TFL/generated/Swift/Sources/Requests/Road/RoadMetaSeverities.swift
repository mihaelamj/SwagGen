...
extension TFL.Road {
    ...
    public enum RoadMetaSeverities {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = [EvenStatusSeverity]

            /** OK */
            case status200([EvenStatusSeverity])

            public var success: [EvenStatusSeverity]? {
                switch self {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode([EvenStatusSeverity].self, from: data))
