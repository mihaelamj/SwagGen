...
public class EvenModelWithBooleanAdditionalProperties: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenModelWithBooleanAdditionalProperties else { return false }
    ...
    public static func == (lhs: EvenModelWithBooleanAdditionalProperties, rhs: EvenModelWithBooleanAdditionalProperties) -> Bool {
