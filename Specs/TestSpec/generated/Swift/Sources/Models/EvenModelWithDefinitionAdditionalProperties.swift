...
public class EvenModelWithDefinitionAdditionalProperties: APIModel {

    public var name: String?

    public var additionalProperties: [String: EvenUser] = [:]
    ...
    public required init(from decoder: Decoder) throws {
        ...
        var decodedAdditionalProperties: [String: EvenUser] = [:]
    ...
    public subscript(key: String) -> EvenUser? {
        get {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenModelWithDefinitionAdditionalProperties else { return false }
    ...
    public static func == (lhs: EvenModelWithDefinitionAdditionalProperties, rhs: EvenModelWithDefinitionAdditionalProperties) -> Bool {
