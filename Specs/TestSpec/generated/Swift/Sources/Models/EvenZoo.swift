...
public class EvenZoo: APIModel {

    public var allOfDog: EvenDog?

    public var anyOfDog: EvenDog?

    public var inlineAnimal: EvenAnimal?

    public var inlineAnimals: [InlineAnimals]?

    public var oneOfDog: EvenDog?

    public var schemaAnimals: [EvenSingleAnimal]?
    ...
    public init(allOfDog: EvenDog? = nil, anyOfDog: EvenDog? = nil, inlineAnimal: EvenAnimal? = nil, inlineAnimals: [InlineAnimals]? = nil, oneOfDog: EvenDog? = nil, schemaAnimals: [EvenSingleAnimal]? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenZoo else { return false }
    ...
    public static func == (lhs: EvenZoo, rhs: EvenZoo) -> Bool {
