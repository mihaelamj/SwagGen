...
public class EvenModelWithAdditionalProperties: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenModelWithAdditionalProperties else { return false }
    ...
    public static func == (lhs: EvenModelWithAdditionalProperties, rhs: EvenModelWithAdditionalProperties) -> Bool {
