...
extension TBX.UserService {
    ...
    public enum UserServiceCreateToken {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = EvenTokenObject

            /** Request was successful */
            case status200(EvenTokenObject)
            ...
            public var success: EvenTokenObject? {
                switch self {
            ...
            public var responseResult: APIResponseResult<EvenTokenObject, EvenResponseError> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(EvenTokenObject.self, from: data))
