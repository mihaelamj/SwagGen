...
public class EvenCostPerLeadByCreditRatingPayoutClause: BirchModel, Decodable, AutoEquatable {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenCostPerLeadByCreditRatingPayoutClause else { return false }
    ...
    public static func == (lhs: EvenCostPerLeadByCreditRatingPayoutClause, rhs: EvenCostPerLeadByCreditRatingPayoutClause) -> Bool {
