...
extension API.Account {
    ...
    public enum CreateAccount {
        ...
        public static let service = APIService<Response>(id: "createAccount", tag: "Account", method: "POST", path: "/accounts", hasBody: true, securityRequirements: [SecurityRequirement(type: "oauth", scopes: ["finance:write"])])

        public final class Request: APIRequest<Response> {

            public var body: EvenAccountWriteData?

            public init(body: EvenAccountWriteData?, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: CreateAccount.service) { defaultEncoder in
