...
extension API.LedgerItem {
    ...
    /** Create a one off ledger item */
    public enum CreateOneOffLedgerItem {

        public static let service = APIService<Response>(id: "createOneOffLedgerItem", tag: "Ledger Item", method: "POST", path: "/ledgerItems/oneOffs", hasBody: true, securityRequirements: [SecurityRequirement(type: "oauth", scopes: ["finance:write"])])

        public final class Request: APIRequest<Response> {

            public var body: EvenOneOffLedgerItemCreateData?

            public init(body: EvenOneOffLedgerItemCreateData?, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: CreateOneOffLedgerItem.service) { defaultEncoder in
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public var responseResult: APIResponseResult<EvenLedgerItem, [Status400]> {
