...
extension API.SubAccount {
    ...
    /**
    Get sub-account owners

    Get a list of sub-account owners filtered by relevant query parameters
    */
    public enum GetSubAccountOwners {

        public static let service = APIService<Response>(id: "getSubAccountOwners", tag: "Sub-Account", method: "GET", path: "/subAccounts/owners", hasBody: false, securityRequirements: [SecurityRequirement(type: "oauth", scopes: ["finance:read"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetSubAccountOwners.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = [EvenLegacySubAccountOwner]

            /** Success */
            case status200([EvenLegacySubAccountOwner])

            public var success: [EvenLegacySubAccountOwner]? {
                switch self {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode([EvenLegacySubAccountOwner].self, from: data))
