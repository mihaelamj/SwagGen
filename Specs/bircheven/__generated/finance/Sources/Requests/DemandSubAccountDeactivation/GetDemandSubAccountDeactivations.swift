...
extension API.DemandSubAccountDeactivation {

    /**
    Get demand sub-account deactivations

    Return demand sub-account deactivations based upon request parameters
    */
    public enum GetDemandSubAccountDeactivations {

        public static let service = APIService<Response>(id: "getDemandSubAccountDeactivations", tag: "Demand Sub-Account Deactivation", method: "GET", path: "/demandSubAccountDeactivations", hasBody: false, securityRequirements: [SecurityRequirement(type: "oauth", scopes: ["finance:read"])])
 ...
 */
                ...
                public init(id: [Int]? = nil, demandSubAccountId: [Int]? = nil, createdAtMin: DateTime? = nil, createdAtMax: DateTime? = nil, createdBy: [ID]? = nil, deletedAtMin: DateTime? = nil, deletedAtMax: DateTime? = nil, isDeleted: Bool? = nil, deletedBy: [ID]? = nil, offset: Int? = nil, limit: Int, sortBy: String? = nil, order: String? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: GetDemandSubAccountDeactivations.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: [Int]? = nil, demandSubAccountId: [Int]? = nil, createdAtMin: DateTime? = nil, createdAtMax: DateTime? = nil, createdBy: [ID]? = nil, deletedAtMin: DateTime? = nil, deletedAtMax: DateTime? = nil, isDeleted: Bool? = nil, deletedBy: [ID]? = nil, offset: Int? = nil, limit: Int, sortBy: String? = nil, order: String? = nil) {
                let options = Options(id: id, demandSubAccountId: demandSubAccountId, createdAtMin: createdAtMin, createdAtMax: createdAtMax, createdBy: createdBy, deletedAtMin: deletedAtMin, deletedAtMax: deletedAtMax, isDeleted: isDeleted, deletedBy: deletedBy, offset: offset, limit: limit, sortBy: sortBy, order: order)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public typealias SuccessType = [EvenDemandSubAccountDeactivation]

            /** Success */
            case status200([EvenDemandSubAccountDeactivation])

            /** Invalid request */
            case status400([Status400])

            public var success: [EvenDemandSubAccountDeactivation]? {
                switch self {
            ...
            public var responseResult: APIResponseResult<[EvenDemandSubAccountDeactivation], [Status400]> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode([EvenDemandSubAccountDeactivation].self, from: data))
