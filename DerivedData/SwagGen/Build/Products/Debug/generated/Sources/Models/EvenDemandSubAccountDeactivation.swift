...
public class EvenDemandSubAccountDeactivation: BirchModel, Decodable, AutoEquatable {

    /** A unique, internal identifier for this resource.
 */
    public var id: Int

    /** An identifier for the demand sub account that is deactivated.
 */
 ...
 */
    ...
    /** Reason why the demand sub account was deactivated.  
 */
 ...
 */
    ...
    public init(id: Int, demandSubAccountId: Int, createdAt: DateTime, createdBy: ID, deactivationReason: String? = nil, deletedAt: DateTime? = nil, deletedBy: ID? = nil) {
        self.id = id
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? EvenDemandSubAccountDeactivation else { return false }
    ...
    public static func == (lhs: EvenDemandSubAccountDeactivation, rhs: EvenDemandSubAccountDeactivation) -> Bool {
