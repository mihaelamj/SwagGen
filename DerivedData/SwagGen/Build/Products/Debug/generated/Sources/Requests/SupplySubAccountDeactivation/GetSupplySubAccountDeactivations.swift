...
extension API.SupplySubAccountDeactivation {

    /**
    Get supply sub-account deactivations

    Return supply sub-account deactivations based upon request parameters
    */
    public enum GetSupplySubAccountDeactivations {

        public static let service = APIService<Response>(id: "getSupplySubAccountDeactivations", tag: "Supply Sub-Account Deactivation", method: "GET", path: "/supplySubAccountDeactivations", hasBody: false, securityRequirements: [SecurityRequirement(type: "oauth", scopes: ["finance:read"])])
 ...
 */
                ...
                public init(id: [Int]? = nil, supplySubAccountId: [Int]? = nil, createdAtMin: DateTime? = nil, createdAtMax: DateTime? = nil, createdBy: [ID]? = nil, deletedAtMin: DateTime? = nil, deletedAtMax: DateTime? = nil, isDeleted: Bool? = nil, deletedBy: [ID]? = nil, offset: Int? = nil, limit: Int, sortBy: String? = nil, order: String? = nil) {
                    self.id = id
            ...
            public init(options: Options) {
                ...
                super.init(service: GetSupplySubAccountDeactivations.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(id: [Int]? = nil, supplySubAccountId: [Int]? = nil, createdAtMin: DateTime? = nil, createdAtMax: DateTime? = nil, createdBy: [ID]? = nil, deletedAtMin: DateTime? = nil, deletedAtMax: DateTime? = nil, isDeleted: Bool? = nil, deletedBy: [ID]? = nil, offset: Int? = nil, limit: Int, sortBy: String? = nil, order: String? = nil) {
                let options = Options(id: id, supplySubAccountId: supplySubAccountId, createdAtMin: createdAtMin, createdAtMax: createdAtMax, createdBy: createdBy, deletedAtMin: deletedAtMin, deletedAtMax: deletedAtMax, isDeleted: isDeleted, deletedBy: deletedBy, offset: offset, limit: limit, sortBy: sortBy, order: order)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public typealias SuccessType = [EvenSupplySubAccountDeactivation]

            /** Success */
            case status200([EvenSupplySubAccountDeactivation])

            /** Invalid request */
            case status400([Status400])

            public var success: [EvenSupplySubAccountDeactivation]? {
                switch self {
            ...
            public var responseResult: APIResponseResult<[EvenSupplySubAccountDeactivation], [Status400]> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode([EvenSupplySubAccountDeactivation].self, from: data))
