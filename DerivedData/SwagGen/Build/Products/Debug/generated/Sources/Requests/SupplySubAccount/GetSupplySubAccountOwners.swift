...
extension API.SupplySubAccount {
    ...
    /**
    get a supply sub-account owner

    Get a list of Sub Account Owners filtered by relevant query parameters
    */
    public enum GetSupplySubAccountOwners {

        public static let service = APIService<Response>(id: "getSupplySubAccountOwners", tag: "Supply Sub-Account", method: "GET", path: "/supplySubAccounts/owners", hasBody: false, securityRequirements: [SecurityRequirement(type: "oauth", scopes: ["finance:read"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetSupplySubAccountOwners.service)
            }
