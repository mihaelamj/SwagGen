...
extension API.SubAccount {
    ...
    Soft delete the sub-account corresponding to the ID in URL path, if one exists
    */
    public enum DeleteSubAccount {

        public static let service = APIService<Response>(id: "deleteSubAccount", tag: "Sub-Account", method: "DELETE", path: "/subAccounts/{id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "oauth", scopes: ["finance:write"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DeleteSubAccount.service)
            }
